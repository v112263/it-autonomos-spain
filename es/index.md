...
<p class="last-updated">Última actualización: 27 de enero de 2026</p>
...
- [Optimización fiscal](#optimización-fiscal)
    ...
    - [Contabilidad y pagos obligatorios](#contabilidad-y-pagos-obligatorios)
        - [Gestor/Xolo](#gestorxolo)
        - [Seguridad Social](#seguridad-social)
        - [Comisiones por transferencias bancarias](#comisiones-por-transferencias-bancarias)
    - [Oficina y servicios públicos](#oficina-y-servicios-públicos)
    ...
    - [Otros esquemas de optimización](#otros-esquemas-de-optimización)
...
{% include es/tax-optimization/0_tax_optimization.md %}
