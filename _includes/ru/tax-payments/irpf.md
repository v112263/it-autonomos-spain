...
- Налог на прирост капитала (от 19% до 30%) - взимается с доходов от продажи активов или инвестиций.
...
1. В случае любых проблем с оплатой IRPF срочно пишите вашему [хестору](#надежные-хесторы), он вам поможет.
2. Для аутономо налог автоматически взимается с банковского счета каждый квартал 20 числа в апреле, июле, октябре
   ...
   debit, важно вовремя подавать [ежеквартальные декларации](#ежеквартальные-декларации). Если 20-е число попадает на выходной день, то снятие будет
...
5. После подачи [годовой декларации](#годовая-декларация-renta) проводится перерасчет: при недоплате IRPF необходимо будет доплатить, а при
   переплате - вам вернут излишек.

Итоговая сумма IRPF за год зависит от множества переменных. Если хотите заранее понимать свою налоговую нагрузку, 
рекомендую [просчитать ее](#сколько-налогов-нужно-будет-заплатить-за-год).
