...
1. Подписаться на телеграм канал [Autonomo & SL](https://t.me/autonomo_and_sl){:target="_blank"} - чтобы 
...
2. Закрыть аналог аутономо в другой стране, если он есть (например, ФОП в Украине).
    - Обязательно ли это делать, до или после регистрации аутономо - лучше узнать у вашего [хестора](#надежные-хесторы). По опыту большинства
...
7. Прочитайте про [мой опыт получения ипотеки для аутономо](https://spainlifeguide.com/ru/mortgage/){:target="_blank"} (спустя 8 месяцев после регистрации) - если планируете брать ипотеку в будущем, мой опыт может быть вам полезен.
