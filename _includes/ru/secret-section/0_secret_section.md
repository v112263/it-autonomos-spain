...
- Присоединяйтесь к нашему [чату аутономо](https://t.me/it_autonomos_spain){:target="_blank"} и подписывайтесь на телеграм канал
  [Autonomo & SL](https://t.me/autonomo_and_sl){:target="_blank"}.
- Если у вас есть Telegram Premium, [забустите канал 
  Autonomo & SL](https://t.me/autonomo_and_sl?boost){:target="_blank"}.
- Поставьте звезду [GitHub репозиторию](https://github.com/v112263/it-autonomos-spain){:target="_blank"} с исходниками документа.
...
- [Если захотите угостить меня кофе](https://buymeacoffee.com/v112263){:target="_blank"} :)
