...
Electrònica de la Comunitat Valenciana), онлайн и (пока) бесплатно.
...
2. Сфотографировать TIE (или водительские права) и пройти видео-верификацию.
3. Дождаться одобрения по e-mail (обычно несколько часов при подаче днём) и действовать по инструкции.
