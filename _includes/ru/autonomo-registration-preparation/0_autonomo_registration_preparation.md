...
Перед регистрацией аутономо вам необходимо оформить ВНЖ с
правом на работу или временную защиту. Рекомендую обратиться к 
[надежным миграционным юристам](#надежные-миграционные-юристы) за помощью с оформлением Digital Nomad, Cuenta Propia 
или другого типа резиденции.

Для регистрации и ведения аутономо можно выбрать один из популярных вариантов: [хестор](#надежные-хесторы) или
сервис [Xolo](https://www.xolo.io/es-en?ref=VLADMY){:target="_blank"}.

Если вы еще не определились с формой деятельности (аутономо, аутономо + колаборадор или SL), рекомендую [просчитать налоговую нагрузку](#сколько-налогов-нужно-будет-заплатить-за-год) для каждого варианта при вашем уровне дохода.

Лично у меня есть большой опыт в использовании обоих вариантов - и услуг хестора, и услуг Xolo. Я могу с уверенностью
сказать, что оба этих варианта хорошие, и можно выбирать тот, который вам больше нравится.
...
[Хестор](#надежные-хесторы) - это специалист по бухгалтерии и налогам, который оказывает персонализированную поддержку
аутономо в вопросах
...
- ⚠️ Не работает в [нескольких регионах Испании и для некоторых сфер деятельности](#подойдет-ли-вам-xolo).
- ⚠️ Консультации не во всех нестандартных ситуациях.

Регистрация по **[реферальной ссылке](https://www.xolo.io/es-en?ref=VLADMY){:target="_blank"}** (бонус 50 € на ваш счет
за регистрацию).
