...
декларацию за 2025 год нужно подать с 8 апреля 2026 года до 30 июня 2026 года (если выбрано автоматическое списание с
банковского счета - до 25 июня 2026).
...
подается декларация. Для 2025 года можно посмотреть
здесь - [Delimitación de la obligación de declarar en el IRPF](https://sede.agenciatributaria.gob.es/Sede/ayuda/manuales-videos-folletos/manuales-practicos/irpf-2025/c01-campana-declaracion-renta/quienes-estan-obligados-presentar-declaracion-irpf/delimitacion-obligacion-declarar-irpf.html){:target="_blank"}.
...
- Аренда: если сдавали жилье и заработали более 1 000 €.
...
Лично я всегда подаю ренту через Xolo, и в целом процесс меня устраивает. Опросник у них удобный, а вся подача довольно
быстрая. С каждым годом Xolo его улучшают - например, в опроснике уже спрашивают про многие
[региональные вычеты](#региональные-вычеты), то есть ведут себя проактивно. Именно с подачей ренты через хестора у меня
личного опыта нет, знаю только по отзывам, но хесторы со своей стороны этот процесс тоже постоянно улучшают.

Кто бы ни готовил вашу декларацию, обязательно тщательно перепроверьте черновик и вникните в него - убедитесь, что в нем
учтены все вычеты, которые вам положены. Финальная ответственность все равно на вас, ведь именно вы проверяете и
подтверждаете итоговый расчет.
...
очень похожий. Во время ответа на вопросы, указывайте информацию за отчетный год. Например, если в 2026 году вы подаете
ренту за 2025 год, то предоставляйте данные, которые были актуальны с 1 января 2025 года до 31 декабря 2025 года.
Некоторые факторы могут уменьшать сумму налога (например, [наличие детей, подача совместной декларации](#личные-и-семейные-налоговые-льготы)).
...
зависимости от ваших ответов на вопросы. Обратите внимание, что у некоторых из них свои сроки подачи, отдельные от Renta.

**Modelo 720** - декларация об иностранных активах. Это информационная декларация, которую подают налоговые резиденты
Испании, если они владеют зарубежными активами на сумму более 50 000 € в одной из трех категорий: банковские счета, ценные
бумаги/страховки, или недвижимость (порог 50 000 € считается отдельно по каждой категории, а не суммарно). Эта декларация
не предполагает уплату налога, но налоговая служба получает данные о ваших зарубежных активах.
После первой подачи Modelo 720 ее нужно обновлять только в случае увеличения сумм более чем на 20 000 € или появления
новых активов. Подается отдельно от Renta - с 1 января по 31 марта.

**Modelo 721** - декларация о криптоактивах за рубежом. Отчет для резидентов, владеющих
криптовалютами на иностранных биржах. Аналогичен Modelo 720, но касается только криптовалют. Обязательна к подаче, если
криптоактивы на зарубежных платформах превышают 50 000 € на конец года. Подается отдельно от Renta - с 1 января по 31
марта.

**Modelo 714** - декларация по налогу на имущество (Impuesto sobre el Patrimonio). По умолчанию подлежит подаче, если
чистая стоимость имущества налогоплательщика превышает 700 000 € (либо 2 000 000 € в брутто-активах, даже если налог к
уплате равен нулю). Этот порог зависит от автономного сообщества - например, в Валенсийском сообществе с 2025 года он
повышен до 1 000 000 €. Включает недвижимость, банковские счета, инвестиции, автомобили, драгоценности и другие активы.
...
В некоторых ситуациях, например при [получении ипотеки](https://spainlifeguide.com/ru/mortgage/){:target="_blank"} или
...
ренты придется покупать для каждого из вас отдельно. Для второй ренты действует скидка 20%.

Я рекомендую заранее рассчитать, во сколько вам обойдется подача ренты. Если стоимость через Xolo оказывается высокой,
