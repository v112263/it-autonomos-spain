...
декларацію за 2025 рік потрібно подати з 8 квітня 2026 року до 30 червня 2026 року (якщо обрано автоматичне списання з
банківського рахунку - до 25 червня 2026).
...
якого
подається декларація. Для 2025 року можна подивитися
тут - [Delimitación de la obligación de declarar en el IRPF](https://sede.agenciatributaria.gob.es/Sede/ayuda/manuales-videos-folletos/manuales-practicos/irpf-2025/c01-campana-declaracion-renta/quienes-estan-obligados-presentar-declaracion-irpf/delimitacion-obligacion-declarar-irpf.html){:target="_blank"}.
...
Особисто я завжди подаю ренту через Xolo, і в цілому процес мене влаштовує. Опитувальник у них зручний, а вся подача
досить швидка. З кожним роком Xolo його покращують - наприклад, в опитувальнику вже запитують про багато
[регіональних вирахувань](#регіональні-вирахування), тобто поводяться проактивно. Саме з подачею ренти через хестора
особистого досвіду в мене немає, знаю тільки з відгуків, але хестори зі свого боку цей процес теж постійно покращують.

Хто б не готував вашу декларацію, обов'язково ретельно перевірте чернетку та вникніть у неї - переконайтеся, що в ній
враховані всі вирахування, які вам належать. Фінальна відповідальність все одно на вас, адже саме ви перевіряєте та
підтверджуєте підсумковий розрахунок.
...
буде
дуже схожий. Під час відповіді на питання, вказуйте інформацію за звітний рік. Наприклад, якщо в 2026 році ви подаєте
ренту за 2025 рік, то надавайте дані, які були актуальні з 1 січня 2025 року до 31 грудня 2025 року.
...
залежно
від ваших відповідей на питання. Зверніть увагу, що у деяких з них свої строки подання, окремі від Renta.

**Modelo 720** - декларація про іноземні активи. Це інформаційна декларація, яку подають податкові резиденти
Іспанії, якщо вони володіють закордонними активами на суму більше 50 000 € в одній з трьох категорій: банківські рахунки,
цінні папери/страховки, або нерухомість (поріг 50 000 € рахується окремо по кожній категорії, а не сумарно). Ця
декларація не передбачає сплату податку, але податкова служба отримує дані про ваші закордонні активи.
Після першого подання Modelo 720 її потрібно оновлювати тільки у випадку збільшення сум більш ніж на 20 000 € або появи
нових активів. Подається окремо від Renta - з 1 січня по 31 березня.

**Modelo 721** - декларація про криптоактиви за кордоном. Звіт для резидентів, які володіють
криптовалютами на іноземних біржах. Аналогічний Modelo 720, але стосується тільки криптовалют. Обов'язкова до подання,
якщо
криптоактиви на зарубіжних платформах перевищують 50 000 € на кінець року. Подається окремо від Renta - з 1 січня по 31
березня.

**Modelo 714** - декларація з податку на майно (Impuesto sobre el Patrimonio). За замовчуванням підлягає поданню, якщо
чиста вартість майна платника податків перевищує 700 000 € (або 2 000 000 € в брутто-активах, навіть якщо податок до
сплати дорівнює нулю). Цей поріг залежить від автономного співтовариства - наприклад, у Валенсійському співтоваристві з
2025 року він підвищений до 1 000 000 €. Включає нерухомість, банківські рахунки, інвестиції, автомобілі, коштовності та
інші активи.
