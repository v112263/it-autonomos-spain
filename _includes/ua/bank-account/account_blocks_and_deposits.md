...
2. Досвід у всіх різний і залежить від конкретного банку, відділення, менеджера та інших факторів.
   У [чаті](https://t.me/it_autonomos_spain){:target="_blank"} згадувалися випадки, коли люди клали по 5,000-10,000 євро
...
4. Щороку банки актуалізують дані клієнта (запитують документи, джерела доходу, місце роботи тощо). Якщо клієнт ігнорує
   цей запит, банк може кілька разів нагадати, а потім заблокувати рахунок до особистого візиту і надання документів. До того ж такий візит, як правило, потрібен саме до того відділення, де ви відкривали рахунок (докладніше - [Прив'язка рахунку до відділення банку](#привязка-рахунку-до-відділення-банку)).
