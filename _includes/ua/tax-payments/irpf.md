...
- Податок на доходи аутономо (від 19% до 47%) - застосовується до доходів, отриманих від професійної чи підприємницької
  діяльності.
- Податок на приріст капіталу (від 19% до 30%) - стягується з доходів від продажу активів або інвестицій.
...
1. У разі будь-яких проблем з оплатою IRPF негайно звертайтеся до свого [хестора](#надійні-хестори), він вам допоможе.
2. Для аутономо податок автоматично стягується з банківського рахунку кожного кварталу 20 числа в квітні, липні,
   ...
   direct debit, важливо вчасно подавати [щоквартальні декларації](#щоквартальні-декларації). Якщо 20-те число припадає на вихідний день, зняття
...
5. Після подачі [річної декларації](#річна-декларація-renta) проводиться перерахунок: у разі недоплати IRPF необхідно буде доплатити, а в разі
   переплати - вам повернуть надлишок.

Підсумкова сума IRPF за рік залежить від багатьох змінних. Якщо хочете заздалегідь розуміти своє податкове навантаження, рекомендую [прорахувати його](#скільки-податків-потрібно-буде-сплатити-за-рік).
