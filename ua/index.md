...
Документ містить всю необхідну інформацію для реєстрації та ведення аутономо: інструкції, лайфхаки та корисні поради.

Інформація збиралася понад півроку мною та учасниками спільноти IT Autonomos [Spain]. Документ регулярно оновлюється.
...
- [Реєстрація Autónomo (step-by-step)](#реєстрація-autónomo-step-by-step)
